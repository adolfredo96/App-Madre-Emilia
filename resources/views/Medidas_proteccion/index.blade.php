	...
	<div class="panel" >
		<div class="panel-header">
			...
			<div class="row" style="margin: 10px;">
					...
					<div>
						<a  href="{!!URL::to('/MedidasProteccion/create')!!}">
			...
			<div>
				...
				<div>
					<table class="table">
						...
						<tbody>
						@foreach($medidas_proteccion as $datos)
						<tr>
						@if($datos != null)
							<td>{{$datos->nombre}}</td> 
							<td>
								<a class="btn btn-info" href="{!!URL::to('/MedidasProteccion/'.$datos->id.'/edit')!!}" style="text-align: center;">
									Ver Opciones
								</a>
							</td>
						@endif
