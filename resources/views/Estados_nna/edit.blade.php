@extends('layouts.principal')
  @section('title', 'Editar Estado NNA')
  ...
  @section('content')
    ...
    <div class="panel">
        <div class="panel-body">
            ...
            <div class="panel-body" >
                {!!Form::model($estados_nna,['route'=>['EstadosNNA.update',$estados_nna],'method'=>'PUT','files' => true])!!}
                    @include('Estados_nna.form.estados_nnaEdit')
                ...
                <div class="row">
                    ...
                    <div class="col-5" style="text-align:left">
                        {!!Form::open(['route'=>['EstadosNNA.destroy', $estados_nna], 'method' => 'DELETE'])!!}
