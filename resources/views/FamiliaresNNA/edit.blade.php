  ...
  @section('content')
    ...
    <div class="panel">
        <div class="panel-body">
            ...
            <div class="panel-body" >
                {!!Form::model($familiaresnna,['route'=>['FamiliaresNNA.update',$familiaresnna],'method'=>'PUT','files' => true])!!}
                    @include('FamiliaresNNA.form.familiaresnnaEdit')
                ...
                <div class="row">
                    ...
                    <div class="col-5" style="text-align:left">
                        {!!Form::open(['route'=>['FamiliaresNNA.destroy', $familiaresnna], 'method' => 'DELETE'])!!}
