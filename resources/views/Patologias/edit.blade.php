    ...
    <div class="panel">
        <div class="panel-body">
            ...
            <div class="row" style="margin: 10px;">
                <div>
                    <h4>Editar Patología</h4>
                </div>
            </div>
            <div class="panel-body" >
                {!!Form::model($patologia,['route'=>['Patologias.update',$patologia],'method'=>'PUT','files' => true])!!}
                    @include('Patologias.form.patologiasEdit')
                ...
                <div class="row">
                    ...
                    <div class="col-5" style="text-align:left">
                        {!!Form::open(['route'=>['Patologias.destroy', $patologia], 'method' => 'DELETE'])!!}
